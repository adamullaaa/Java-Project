...
public Form6(int index) throws FileNotFoundException {
...
textField.setText(Data.customers.get(index).getName());

textField_1 = new JTextField();
textField_1.setColumns(10);
textField_1.setBounds(506, 181, 205, 33);
getContentPane().add(textField_1);
textField_1.setText(Data.customers.get(index).getContact());

textField_2 = new JTextField();
textField_2.setColumns(10);
textField_2.setBounds(275, 230, 205, 33);
getContentPane().add(textField_2);
textField_2.setText(Data.customers.get(index).getCustomerID());

textField_3 = new JTextField();
textField_3.setColumns(10);
textField_3.setBounds(516, 290, 205, 33);
getContentPane().add(textField_3);
textField_3.setText(Data.customers.get(index).getUsername());

textField_4 = new JTextField();
textField_4.setColumns(10);
textField_4.setBounds(298, 351, 205, 33);
getContentPane().add(textField_4);
textField_4.setText(Data.customers.get(index).getPassword());


JButton btnNewButton = new JButton("Update");
btnNewButton.setBackground(Color.WHITE);
btnNewButton.setFont(new Font("Tahoma", Font.ITALIC, 20));
btnNewButton.setBounds(336, 420, 129, 39);
getContentPane().add(btnNewButton);
JLabel lblNewLabel_5 = new JLabel("Customer Update");
lblNewLabel_5.setForeground(Color.WHITE);
lblNewLabel_5.setFont(new Font("Tahoma", Font.BOLD | Font.ITALIC, 30));
lblNewLabel_5.setBounds(256, 10, 306, 68);
